...
Properties
spring.application.name=fretmart
spring.datasource.url=jdbc:postgresql://localhost:5432/fretmart_db
...
Bash
# Clean project dependencies and execute compile-time test suites
mvn clean test

# Initialize database evolutionary migrations and launch application engine
mvn spring-boot:run